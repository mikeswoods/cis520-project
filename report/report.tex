...
Our performance against the quiz set was as follows:
Learners
Mean RMSE
\texttt{counts\_logit\_reg}
1.0314
\texttt{counts\_logit\_reg}, \texttt{nb}
0.9723
\texttt{counts\_logit\_reg}, \texttt{nb}, \texttt{counts\_svm}
0.9548
\texttt{counts\_logit\_reg}, \texttt{nb}, \texttt{counts\_svm}, kmeans
0.9446
\texttt{counts\_logit\_reg}, \texttt{nb}, \texttt{counts\_svm}, business\_user\_classifier2
1.0413
