...
% code
%
% MULTI_MIRA_PERCEPTRON.TEST(X_train, Y_train, X_test)
%
...
model = multi_mira_perceptron.train(X_train, Y_train, train_idx);

Y_predict = multi_mira_perceptron.predict(model, X_test, test_idx);
