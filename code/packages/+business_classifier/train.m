...
%
% BUSINESS_CLASSIFIER.TRAIN(train_labels, train_data, opts)
%
...
%
metadata = load('../data/business_metadata.mat');

mdl = fitensemble(metadata.business_id_idx(train_idx,:), Y_train, 'LSBoost', 5, 'tree');
